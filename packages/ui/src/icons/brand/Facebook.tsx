// Facebook (Meta) glyph. `currentColor` so the surrounding control's
// text colour drives the fill.

import type { BrandIconProps } from './types';

export function Facebook({ className, 'aria-hidden': ariaHidden = true, ...rest }: BrandIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
