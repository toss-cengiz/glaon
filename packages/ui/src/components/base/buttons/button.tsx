// @ts-nocheck
// UUI kit source — pulled via `npx untitledui add button`. The kit ships
// without strict-mode-compliant typings (unused React import, optional
// boolean props that bump into exactOptionalPropertyTypes); rather than
// fork the file, we suppress type-check here so `untitledui upgrade`
// stays a clean replace operation. Re-apply this comment after every
// kit upgrade until UUI tightens their own types.
'use client';
